    ...
    def init_monster(self,lchunck_monsters):
        ...
        for (chunk, id, x, y, name,side) in lchunck_monsters :
            ...
            if name == 0:
                ...
                self.dic_monster[chunk][id] = monster.Mma(x, y, chunk, self.cell_size, 0) #Mma fighter xd

            elif name == 10:
                self.dic_monster[chunk][id] = monster.Shaman(x, y, chunk, self.cell_size, 0) #Mma fighter xd
